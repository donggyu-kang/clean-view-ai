export function Ico({ name, size = 16, color = 'currentColor', strokeWidth = 1.6 }) {
  ...
  const paths = {
    ...
    trash:      <svg style={s} viewBox="0 0 24 24"><polyline {...p} points="3 6 5 6 21 6"/><path {...p} d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><path {...p} d="M10 11v6"/><path {...p} d="M14 11v6"/><path {...p} d="M9 6V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2"/></svg>,
  }
